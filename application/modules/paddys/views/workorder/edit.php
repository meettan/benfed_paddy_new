            ...
            <form method="POST" id="form"
                ...
                <input type="hidden"
                  ...
                  <div class="form-group row">
                    <label for="pre_order_no" class="col-sm-2 col-form-label">Order No:</label>
                    <div class="col-sm-10">
                        <input type="text" 
                         class="form-control" name="pre_order_no" id="pre_order_no" value="<?php echo $workorder_dtls->pre_order_no;?>" readonly />
                    </div>
