            ...
            .done(function(data){
                ...
                $.each(JSON.parse(data), function( index, value ) {
                    ...
                    sgst_amt     += parseFloat(value.sgst_amt);
                        ...
                        string +='<tr><td><b>Total:</b></td><td></td><td><b><input type="text" class="form-control" id="gross_amt" value="'+gross_amt.toFixed(2)+'" readonly></b></td><td><b><input type="text" class="form-control" id="tds_amt" value="'+tds_amt.toFixed(2)+'" readonly></b></td><td></td><td><b><input type="text" class="form-control" id="cgst_amt" value="'+cgst_amt.toFixed(2)+'" readonly></b></td><td><b><input type="text" class="form-control" id="sgst_amt" value="'+sgst_amt.toFixed(2)+'" readonly></b></td><td></td><td><b><input type="text" class="form-control" id="tot_rice" value="'+price_sum.toFixed()+'" readonly></b></td></tr></tbody></table>';
         ...
         $(".calculate").click(function(){
           ...
           $.get('<?php echo site_url("paddys/payment/f_tdsrate"); ?>',{
                    ...
                    $("input[class *= 'paybel']").each(function(){
                      ...
                      // console.log(tax_amt,tds_amt,cgst,sgst);
                    $("input[class *= 'tds_amount']").each(function(){
            
                        tot_tds += parseFloat($(this).val());

                    });

                    $('#tot_rice').val(Number(sum).toFixed());
                    $('#tds_amt').val(Number(tot_tds).toFixed(2));
